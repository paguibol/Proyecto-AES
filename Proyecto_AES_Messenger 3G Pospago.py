...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("Facebook_3G_Pospago")
    sleep(2)
...
def Messenger(d, destination_contact, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_2_columns(i+1, current_time, col_a="C", col_b="D", start_row=62, NW="3G", total_reps=repetitions)    #Escribe en Excel, pasar en que columna, fila y RAT empieza a escribir. Pospago celda =C62  y D62 ; Prepago con saldo celda = K49 y L62; prepago sin saldo celda= T76
