...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("Gmail_4G_Pospago")
    sleep(2)
...
def Gmail(d, destination_email, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_2_columns(i+1, current_time, col_a="G", col_b="H", start_row=62, NW="4G", total_reps=repetitions)    #Escribe en Excel, pasar en que columna, fila y RAT empieza a escribir. Pospago celda =G62  y H62 ; Prepago con saldo celda = O62 y P62
        ...
        write_start_end_time_test_to_Excel(tiempo_inicio, tiempo_fin, col_c="C", col_d="D", start_row=26, NW="4G")  # Escribe en Excel el tiempo de la primera y última iteración del test, en las columnas C y D respectivamente, para la tecnología 3G. 
