...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("Internet_3G_Pospago")
    sleep(2)
...
def chrome_news(d, repetitions=5, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_1_column(i+1, current_time, col="G", start_row=36, NW="3G", total_reps=repetitions)                #Escribe en Excel, pasar en que columna, fila y RAT empieza a escribir. Pospago celda =G36; Prepago con saldo celda = O36; prepago sin saldo celda= T56 
        ...
        write_start_end_time_test_to_Excel(tiempo_inicio, tiempo_fin, col_c="C", col_d="D", start_row=22, NW="3G")  # Escribe en Excel el tiempo de la primera y última iteración del test, en las columnas C y D respectivamente, para la tecnología 3G. 
