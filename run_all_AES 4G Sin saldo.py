...
DEFAULT_SCRIPTS = [
    "Proyecto_AES_MMS 4G Sin saldo.py",
    "Proyecto_AES_Internet 4G Sin saldo.py",
    "Proyecto_AES_Youtube 4G Sin saldo.py",
    "Proyecto_AES_Twitter 4G Sin saldo.py",
    "Proyecto_AES_Messenger 4G Sin saldo.py",
    "Proyecto_AES_Gmail 4G Sin saldo.py",
]
...
def run_script(path: Path, email: str, phone: str, userx: str, userf: str, timeout: int):
    ...
    with open(log_path, "w", encoding="utf-8") as f:
        ...
        try:
            ...
            _timeout_cfg = {
                "Proyecto_AES_MMS.py":       ("MMS_REPS",       "5", "MMS_INTERVAL",       "60", 120),
                "Proyecto_AES_Youtube.py":    ("YT_REPS",        "5", "YT_INTERVAL",        "60",  60),
                "Proyecto_AES_Internet.py":   ("INTERNET_REPS",  "5", "INTERNET_INTERVAL",  "60",  60),
                "Proyecto_AES_Messenger.py":  ("MESSENGER_REPS", "5", "MESSENGER_INTERVAL", "60",  60),
                "Proyecto_AES_Twitter.py":    ("TWITTER_REPS",   "5", "TWITTER_INTERVAL",   "60",  60),
                "Proyecto_AES_Gmail.py":      ("GMAIL_REPS",     "5", "GMAIL_INTERVAL",     "60",  60),
            }
            try:
