...
def Twitter(d, destination_contact, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        write_time_to_Excel_2_columns(i+1, current_time, col_a="G", col_b="H", start_row=49, NW="3G")    #Escribe en Excel, pasar en que columnas, fila y RAT empieza a escribir,   
