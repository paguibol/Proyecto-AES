...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("Facebook_4G_Pospago")
    sleep(2)
...
def Messenger(d, destination_contact, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_2_columns(i+1, current_time, col_a="C", col_b="D", start_row=62, NW="4G", total_reps=repetitions)    #Escribe en Excel, pasar en que columna, fila y RAT empieza a escribir. Pospago celda =C62  y D62 ; Prepago con saldo celda = K49 y L62; prepago sin saldo celda= T76
        ...
        write_start_end_time_test_to_Excel(tiempo_inicio, tiempo_fin, col_c="C", col_d="D", start_row=25, NW="4G")  # Escribe en Excel el tiempo de la primera y última iteración del test, en las columnas C y D respectivamente, para la tecnología 3G. 
