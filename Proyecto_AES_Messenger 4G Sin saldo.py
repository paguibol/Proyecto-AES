...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("Facebook_4G_Sin Saldo")
    sleep(2)
...
def Messenger(d, destination_contact, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_1_column(i+1, current_time, col="T", start_row=116, NW="4G", total_reps=repetitions)                 # Descomentar MMS - Prepago sin saldo prepago sin saldo celda= T116
        ...
        write_start_end_time_test_to_Excel(tiempo_inicio, tiempo_fin, col_c="G", col_d="H", start_row=25, NW="4G")  # Escribe en Excel el tiempo de la primera y última iteración del test, en las columnas C y D respectivamente, para la tecnología 3G. 
