...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("X_3G_Prepago")
    sleep(2)
...
def Twitter(d, destination_contact, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_2_columns(i+1, current_time, col_a="O", col_b="P", start_row=49, NW="3G", total_reps=repetitions)    #Escribe en Excel, pasar en que columnas, fila y RAT empieza a escribir,    
        ...
        write_start_end_time_test_to_Excel(tiempo_inicio, tiempo_fin, col_c="E", col_d="F", start_row=24, NW="3G")  # Escribe en Excel el tiempo de la primera y última iteración del test, en las columnas C y D respectivamente, para la tecnología 3G. 
