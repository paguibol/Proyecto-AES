...
def Gmail(d, destination_email, repetitions=20, interval=60):
    ...
    for i in range(repetitions):
        ...
        resultado = write_time_to_Excel_2_columns(i+1, current_time, col_a="O", col_b="P", start_row=62, NW="4G", total_reps=repetitions)    #Escribe en Excel, pasar en que columna, fila y RAT empieza a escribir. Pospago celda =G62  y H62 ; Prepago con saldo celda = O62 y P62
