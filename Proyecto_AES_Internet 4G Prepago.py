...
def close_log(d):
    ...
    d(resourceId="android:id/edit").set_text("Internet_4G_Prepago")
    sleep(2)
...
def chrome_news(d, repetitions=5, interval=60):
    ...
    for i in range(repetitions):
        ...
        write_start_end_time_test_to_Excel(tiempo_inicio, tiempo_fin, col_c="E", col_d="F", start_row=22, NW="4G")  # Escribe en Excel el tiempo de la primera y última iteración del test, en las columnas C y D respectivamente, para la tecnología 3G. 
